...
public class JavalapsTeam9Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User manager1 = new User(1,"manager1", "Cher", "Wah", "12345", "cherweh@gmail.com", Roles.MANAGER, Scheme.PROFESSIONAL, format.parse("2019-01-02"), 18, 60, 2);
		adminService.saveUser(manager1);
		
		User manager2 = new User(2,"manager2", "Marcus", "Foo", "12345", "marcusfoo@gmail.com", Roles.MANAGER, Scheme.PROFESSIONAL, format.parse("2019-01-02"), 7, 59, 2);
		adminService.saveUser(manager2);
		
		User admin = new User(3,"admin1", "Suria", "R Asai", "12345","suria@gmail.com", Roles.ADMIN, Scheme.ADMINISTRATIVE, format.parse("2019-01-02"), 14, 60, 1);
		adminService.saveUser(admin);
		
		User employee1 = new User(4,"emp1", "Dickson", "Lee", "12345", "dicksonlee@gmail.com", Roles.STAFF, Scheme.PROFESSIONAL, format.parse("2019-01-02"), 12, 58, 1);
		adminService.saveUser(employee1);
		
		User employee2 = new User(5,"emp2", "Howard", "Teo", "12345", "howardteo@gmail.com", Roles.STAFF, Scheme.PROFESSIONAL, format.parse("2019-01-02"), 13, 60, 1);
